...
export default async function dbConnect(cb) {
  try {
    ...
    const uri = `mongodb+srv://${process.env.ATLAS_NAME}@${process.env.ATLAS_ADDRESS}/compassnfc?retryWrites=true&w=majority&appName=${process.env.ATLAS_COLLECTION}`;
    ...
    // const uti = `"mongodb+srv://compass_dev:rR9COYJoJO3ACbh7@compassnfc.w68cr.mongodb.net/compassnfc?retryWrites=true&w=majority&appName=compassnfc"`
